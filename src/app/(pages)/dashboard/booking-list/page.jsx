...
const page = async () => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(`http://lhttps://luxury-center.vercel.app//api/book-service?userId=${user?._id}`, {
                method: 'GET'
            });
    ...
    const handleCancelBooking = async (id) => {
        ...
        try {
            const response = await fetch(`http://lhttps://luxury-center.vercel.app//api/book-service/${id}`, {
                method: 'DELETE',
            });
