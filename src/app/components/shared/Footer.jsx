          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div>
              ...
              <div className="flex space-x-4">
                ...
                >
                  {" "}
                  <FaFacebook className="h-8 w-8 hover:scale-110 duration-500" />
                </a>
                ...
                >
                  {" "}
                  <FaLinkedin className="h-8 w-8 hover:scale-110 duration-500" />
                </a>

                <a href="https://github.com/iamsujonsheikh" target="_blank">
                  {" "}
                  <FaGithub className="h-8 w-8 hover:scale-110 duration-500" />
                </a>
              </div>{" "}
              <br />
            ...
            <div>
              ...
              <p>
                This is a custom text that you can replace with your own
                content. Feel free to add any information relevant to your
                website or project.
              </p>
              <br />
            </div>
